...
// Nombre de la foto guardada en SPIFFS
...
// Motor pins
const int leftMotorPin1 = GPIO_NUM_12;
const int leftMotorPin2 = GPIO_NUM_13;
const int rightMotorPin1 = GPIO_NUM_14;
const int rightMotorPin2 = GPIO_NUM_15;
...
void setup() {
  ...
  pinMode(M1_Izquierda, OUTPUT);
  pinMode(M1_Derecha, OUTPUT);
  pinMode(M2_Izquierda, OUTPUT);
  pinMode(M2_Derecha, OUTPUT);

  digitalWrite(flash_led, LOW);
  digitalWrite(M1_Izquierda, LOW);
  digitalWrite(M1_Derecha, LOW);
  digitalWrite(M2_Izquierda, LOW);
  ...
  // Imprimir ESP32 Local IP Address
...
{
  if(direccion == 1){
    digitalWrite(M1_Izquierda, HIGH);
    digitalWrite(M1_Derecha, LOW);
    digitalWrite(M2_Izquierda, LOW);
    digitalWrite(M2_Derecha, LOW);
    delay(500);
    ...
    digitalWrite(M1_Izquierda, LOW);
    digitalWrite(M1_Derecha, LOW);
    digitalWrite(M2_Izquierda, HIGH);
    digitalWrite(M2_Derecha, LOW);
    delay(500);
  }stop();
}
